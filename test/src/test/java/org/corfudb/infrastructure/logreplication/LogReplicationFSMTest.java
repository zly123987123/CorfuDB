...
public class LogReplicationFSMTest extends AbstractViewTest implements Observer {
    ...
    private void initLogReplicationFSM(ReaderImplementation readerImpl) {
        ...
        CorfuReplicationSession replicationSession = CorfuReplicationSession.getDefaultReplicationSessionForCluster(
        ...
        switch(readerImpl) {
            ...
            case STREAMS:
                ...
                Map<CorfuReplicationSubscriber, Set<String>> tablesMap = new HashMap<>();
