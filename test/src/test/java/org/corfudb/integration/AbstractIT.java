...
public class AbstractIT extends AbstractCorfuTest {
    ...
    public void setUp() throws Exception {
        // these tests kill corfu server or lr server in the middle, so need to kill them immediately
        // therefore, the test coverage data in server side of these tests are missing from the coverage data
