...
public class LogReplicationSourceManager {
    ...
    public LogReplicationSourceManager(LogReplicationRuntimeParameters params,
        ...
        LogReplicationConfigManager tableManagerPlugin, CorfuReplicationSession replicationSession) {
        ...
        Set<String> streamsToReplicate = config.getReplicationModelToStreamsMap().get(replicationSession.getSubscriber());
