...
public class LogReplicationServer extends AbstractServer {
    ...
    private Map<CorfuReplicationSession, LogReplicationSinkManager> sourceSessionToSinkManagerMap = new HashMap<>();
    ...
    public LogReplicationServer(@Nonnull ServerContext context, String localNodeId, LogReplicationConfig config,
        ...
        Map<CorfuReplicationSession, LogReplicationMetadataManager> sourceSessionToMetadataManagerMap) {
    ...
    public LogReplicationServer(@Nonnull ServerContext context, LogReplicationSinkManager sinkManager,
     ...
     private void createSinkManagers(LogReplicationConfig logReplicationConfig, String localEndpoint,
        ...
        for (Map.Entry<CorfuReplicationSession, LogReplicationMetadataManager> entry :
    ...
    private void handleLrEntryRequest(@Nonnull RequestMsg request,
        ...
        if (isLeader.get()) {
            ...
            LogReplicationSinkManager sinkManager = sourceSessionToSinkManagerMap.get(
                CorfuReplicationSession.getDefaultReplicationSessionForCluster(sourceClusterId));
    ...
    private void handleMetadataRequest(@Nonnull RequestMsg request,
        ...
        if (isLeader.get()) {
            String sourceClusterId = getUUID(request.getHeader().getClusterId()).toString();
            CorfuReplicationSession sourceSession = CorfuReplicationSession
