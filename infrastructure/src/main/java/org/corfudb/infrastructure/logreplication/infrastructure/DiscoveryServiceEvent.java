...
public class DiscoveryServiceEvent {
    ...
    private CorfuReplicationSubscriber replicationSubscriber;
    ...
    public DiscoveryServiceEvent(DiscoveryServiceEventType type, CorfuReplicationSubscriber subscriber) {
        this.type = type;
