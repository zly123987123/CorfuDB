...
public class LogReplicationConfig {
    ...
    private Map<CorfuReplicationSubscriber, Set<String>> replicationModelToStreamsMap = new HashMap<>();
     ...
     */
    @VisibleForTesting
    public LogReplicationConfig(Map<CorfuReplicationSubscriber, Set<String>> streamsToReplicateMap) {
     ...
     */
    public LogReplicationConfig(Map<CorfuReplicationSubscriber, Set<String>> streamsToReplicateMap, int maxNumMsgPerBatch,
                                int maxMsgSize, int cacheSize) {
        replicationModelToStreamsMap = streamsToReplicateMap;
